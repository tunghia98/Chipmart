namespace DTO
{
    public class ProductDTO
    {
        ...
        public ProductDTO(string productId, string productName, byte[] productImg, string unit, int quantity, double importPrice, double priceToSell, string categoryId, bool statusItem, string barcode)
        {
            this.ProductId = productId;
            this.ProductName = productName;
            this.ProductImg = productImg;
