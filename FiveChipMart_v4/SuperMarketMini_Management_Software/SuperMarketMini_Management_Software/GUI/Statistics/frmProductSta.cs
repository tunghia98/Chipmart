    ...
    public partial class frmProductSta : Form
    {
        ...
        private void LoadDateToDataGridView()
        {
            ...
            if (string.IsNullOrWhiteSpace(txtFrom.Texts))
            {
                ...
                if (txtFrom.Texts.Length >= 8)
                {
                    from = 99999999;
                }
                else from = int.Parse(txtFrom.Texts);
            }

            if (string.IsNullOrWhiteSpace(txtTo.Texts))
            {
                to = -1;
            }
            else
            {
                if (txtTo.Texts.Length >= 8)
                {
                    to = 99999999;
                }
                else to = int.Parse(txtTo.Texts);
            }
            ...
            {
                if (string.IsNullOrWhiteSpace(txtMoreThan.Texts))
                {
                    from = -1;
                }
                else
                {
                    if(txtMoreThan.Texts.Length >= 8)
                    {
                        from = 99999999;
                    }
                    else from = int.Parse(txtMoreThan.Texts);
                }
            ...
            {
                if (string.IsNullOrWhiteSpace(txtLessThan.Texts))
                {
                    from = -1;
                }
                else
                ...
                {
                    if (txtLessThan.Texts.Length >= 8)
                    {
                        to = 99999999;
                    }
                    else to = int.Parse(txtLessThan.Texts);
                }
